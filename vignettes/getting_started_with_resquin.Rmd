...
### Handling of missing data and impact on the interpretation of response quality
indicators
...
by `NA` values than others. Indicators calculated with `resp_distribution()` are
not affected as much by missing data, because the `resp_distribution()` indicators
