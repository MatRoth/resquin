...
* Implementation of indices from the careless responding literature: [careless](https://cran.r-project.org/package=careless)
* Autocorrelation and pattern indices: [responsePatterns](https://cran.r-project.org/package=responsePatterns)
...
*[Model Multivariate Ordinal Responses Including Response Styles](https://cran.r-project.org/package=MultOrdRS)
*[Person fit indices (Perfit)](https://cran.r-project.org/package=PerFit)
