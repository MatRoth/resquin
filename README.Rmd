...
implemented) provide response quality indicators geared towards multi-item
...
For a more information how to use `resquin` see the vignettes [Getting started with resquin](doc/getting_started_with_resquin.html) and [Resquin in practice](doc/resquin_in_practice.html).
